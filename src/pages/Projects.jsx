...
import { phase_1_projects, phase_2_projects } from "../constants/projects"

const Projects = () => {
    return (
        <Container>
            <h2 className="text-2xl font-bold text-center mt-15">Phase 1 Projects (UI + Basics)</h2>
            ...
            <h2 className="text-2xl font-bold text-center mt-15">Phase 2 Projects (Real Features)</h2>
            <div className="mt-15 mb-50 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {phase_2_projects.map((project) => (
                    <div key={project.id} className="bg-card-bg p-4 rounded-2xl shadow hover:shadow-lg transition-all border border-card-border flex flex-col justify-between">
                        <div className="overflow-hidden rounded-2xl shadow-lg">
                            <img src={project.img} alt={project.name} />
                        </div>
